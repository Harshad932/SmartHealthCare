// frontend/components/VoiceConsultation.js
...
const VoiceConsultation = ({ appointmentId, patientInfo, onClose }) => {
  ...
  const initializeSpeechRecognition = () => {
    ...
    recognition.lang = 'en-IN'; // Indian English - captures Hindi/Marathi too
    recognition.maxAlternatives = 1; // Get only the top result for consistency
    ...
    recognition.onresult = (event) => {
        ...
        // Update interim transcript (you'll need to add this state)
  ...
  setTranscript('');
  setInterimTranscript(''); // Add this line
  setReports(null);
  setError('');
